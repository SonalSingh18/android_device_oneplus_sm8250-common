...
# android.hardware.wifi.rtt is intentionally not declared: lowi-server never
# answers the RTT capabilities request, so IWifiRttController.getCapabilities
# blocks the single-threaded Wi-Fi HAL binder pool for 14s on every Wi-Fi
# enable, stalling IWifiManager callers and ANR'ing Settings.
PRODUCT_COPY_FILES += \
